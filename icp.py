"""
Source: https://github.com/richardos/icp/blob/master/icp.py
"""
...
def icp(reference_points, points, max_iterations=100, distance_threshold=30, convergence_translation_threshold=1e-3,
    ...
    :return: Final transformation and points
    """
    ...
    # Calculate final transformations from transformation history
    R_total = np.eye(2)
    T_total = np.zeros(2)
